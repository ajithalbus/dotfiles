# Generated by Powerlevel10k configuration wizard on 2019-10-19 at 16:18 IST.
...
() {
  ...
  # Unset all conxiguration options. This allows you to apply configiguration changes without
  ...
  #custom
  #typeset -g POWERLEVEL9K_CONTEXT_DEFAULT_BACKGROUND='5'
  ...
  #typeset -g POWERLEVEL9K_RIGHT_PROMPT_ELEMENTS=()
  typeset -g POWERLEVEL9K_HISTORY_BACKGROUND='red'
  typeset -g POWERLEVEL9K_HISTORY_FOREGROUND='0'
  typeset -g POWERLEVEL9K_VI_MODE_BACKGROUND='black'
